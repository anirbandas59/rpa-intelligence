/**
 * Icon component - SVG icon library from exploration files
 * Source: backend/data/samples/web/shell.jsx
 *
 * Simple line icons matching the exploration design system.
 * Uses stroke-based rendering for consistent visual weight.
 */

import React from "react";

// Icon path definitions from exploration
const ICON_PATHS: Record<string, string> = {
  ...
  alert:
    "M10.3 3.9L1.8 18a2 2 0 001.7 3h17a2 2 0 001.7-3L14.4 3.9a2 2 0 00-3.4 0zM12 9v4M12 17h.01",
  ...
  refresh:
    "M3 12a9 9 0 0015-6.7L21 8M21 3v5h-5M21 12a9 9 0 01-15 6.7L3 16M3 21v-5h5",
  ...
  copy: "M9 5H7a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2",
};

export interface IconProps {
  /** Icon name from the exploration library */
  ...
  /** Fill color (defaults to stroke-based rendering) */
  fill?: string;
}

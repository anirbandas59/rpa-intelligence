...
async def test_full_cross_stage_flow(async_client, test_user_token, test_project):
    ...
    readiness = await async_client.get(
        f"/api/v1/use-cases/{use_case_id}/readiness",
        headers=headers
    )
    ...
    s2_run_detail = await async_client.get(
        f"/api/v1/use-cases/{use_case_id}/s2/runs/{s2_run_id}",
        headers=headers
    )
    ...
    s3_run_response = await async_client.post(
        f"/api/v1/use-cases/{use_case_id}/s3/runs",
        headers=headers
    )
    ...
    s3_run_detail = await async_client.get(
        f"/api/v1/use-cases/{use_case_id}/s3/runs/{s3_run_id}",
        headers=headers
    )
    ...
    load_s4_from_s2 = await async_client.post(
        f"/api/v1/use-cases/{use_case_id}/s4/load-from-s2",
        json={},
        headers=headers
    )
    ...
    load_s4_from_s3 = await async_client.post(
        f"/api/v1/use-cases/{use_case_id}/s4/load-from-s3",
        json={},
        headers=headers
    )
...
async def test_load_from_independent_copy(async_client, test_user_token, test_project):
    ...
    # Get S2 result
    s2_detail = await async_client.get(
        f"/api/v1/use-cases/{use_case_id}/s2/runs/{s2_run_id}",
        headers=headers
    )

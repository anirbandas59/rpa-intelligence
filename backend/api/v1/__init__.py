...
v1_router.include_router(stage1.router, prefix="/use-cases", tags=["stage1"])
v1_router.include_router(stage2.router, prefix="/use-cases", tags=["stage2"])
v1_router.include_router(stage3.router, prefix="/use-cases", tags=["stage3"])
v1_router.include_router(stage4.router, prefix="/use-cases", tags=["stage4"])

...
- Frontend: Next.js 15, shadcn **Nova** preset, Tailwind **v4** (CSS-based config — no `tailwind.config.js`)
...
## Project 2 Reference and Location

This is the older codebase for Complexity Calculator project built with Python + Streamlit. Use it for reference purpose.
Location: ~/workspace/projects/rpa-complexity-agent
...
│       ├── test_api.py
│       ├── test_attribute_scorer.py
│       ├── test_classifier.py
│       ├── test_classifier_tool.py
│       ├── test_complexity_assessment_agent.py
│       ├── test_constants.py
│       ├── test_document_intelligence_agent.py
│       ├── test_docx_parser.py
│       ├── test_effort_table.py
...
│   │   ├── layout_identifier.py
│   │   ├── prompts.py
│   │   ├── __pycache__
│   │   ├── rpa_tool_detector.py
│   │   ├── rule_extractor.py
